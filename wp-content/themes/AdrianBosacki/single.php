...
while ( have_posts() ) :
    the_post();
    get_template_part( 'template-parts/content-page'); // Get template for displaying content of this post.    
...
<section class="section-see-also" >
	<div class="section-see-also__wrapper">
        ...
        <?php global $post; // Get 3 random posts for "See also section"
        $myposts = get_posts( array( 'posts_per_page' => 3, 'orderby' => 'rand', ) );
...
<section class="section-comments">
  ...
  <div class="section-comments__comment">
    <div class="section-comments__img-wrap">
      <img src="/images/resources/profile1.jpg" alt="profile picture" />
    </div>
    <div>
  ...
  <div class="section-comments__comment">
    <div class="section-comments__img-wrap">
      <img src="/images/resources/profile2.jpg" alt="profile picture" />
    </div>
    <div>
  ...
  <div class="section-comments__comment">
    <div class="section-comments__img-wrap">
      <img src="/images/resources/profile3.jpg" alt="profile picture" />
    </div>
    <textarea
      class="section-comments__textarea"
